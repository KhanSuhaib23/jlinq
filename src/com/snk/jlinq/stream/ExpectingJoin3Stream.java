...
public class ExpectingJoin3Stream<T1, T2, T3> extends InJoinExpressionExtender<Tuple3<T1, T2, T3>, ExpectingJoin3Stream<T1, T2, T3>> {
    ...
    public ExpectingJoin3Stream(ExpressionBuilder<Tuple3<T1, T2, T3>, Tuple0, ExpectingJoin3Stream<T1, T2, T3>> baseExpression) {
        super(baseExpression);
    }

    @Override
    public StreamOp<Tuple3<T1, T2, T3>, Tuple0> operatingStream() {
