...
public class ExpectingJoin1Stream<T> extends SortableStream<T, T> {
    ...
    public <TN> InJoinExpectingOn<T, TN, Tuple2<T, TN>, ExpectingJoin2Stream<T, TN>> join(String alias, EnrichedStream<TN, Tuple0> stream) {
        return new InJoinExpectingOn<>(operatingStream(),
    ...
    public <TN> InJoinExpectingOn<T, TN, Tuple2<T, TN>, ExpectingJoin2Stream<T, TN>> join(EnrichedStream<TN, Tuple0> stream) {
        return new InJoinExpectingOn<>(operatingStream(),
