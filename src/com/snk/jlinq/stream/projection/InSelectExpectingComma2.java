...
public class InSelectExpectingComma2<RT1, RT2, OT> extends ProjectedStream<Tuple2<RT1, RT2>, OT> {
    public InSelectExpectingComma2(SelectStream<OT> baseStream, List<MemberAccessor> projections, MemberAccessor additionalProjection) {
        super(baseStream, projections, additionalProjection);
    }
}
