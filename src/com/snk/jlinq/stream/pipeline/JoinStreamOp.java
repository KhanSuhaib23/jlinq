...
public class JoinStreamOp<T1, T2, OT> implements StreamOp<OT> {
    private final StreamOp<T1> left;
    private final StreamOp<T2> right;
    private final Condition condition;
    private final BiFunction<T1, T2, OT> mapper;

    public JoinStreamOp(StreamOp<T1> left, StreamOp<T2> right, Condition condition, BiFunction<T1, T2, OT> mapper) {
        this.left = left;
        this.right = right;
